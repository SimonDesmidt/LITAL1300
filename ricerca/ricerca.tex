...
Oltretutto, parlando degli sentimenti, c'è un sentimento che noi, Tifosi di Ferrari, conosciamo bene: la nostalgia. L'ultimo mondiale è del 2008, e da allora abbiamo avuto molta speranza, ma purtroppo non abbiamo vinto mai. C'erano opportunità, certo, ma gli altri sono sempre stati più forti. La nostalgia signfica "il dolore del ritorno", ma non è tristezza, è carburante perché è speranza. È ciò che ci fa credere che prima o poi torneremo a vincere. È un legame profondo con il passato che ci spinge verso il futuro. L'anno prossimo è il nostro anno!

Per tutto ciò, in questo fine d'anno, auguro a tutti voi nella vita un po' di tifosità e di nostalgia! Perché la vita è più bella quando ci si sente vive dentro.
...
La parola ha un'origine interessante: viene dal greco "nóstos" (ritorno), e "álgos" (dolore). Letteralmente significa “il dolore del ritorno”, e era usata in passato per descrivere un profondo desiderio e dolore per il ritorno a luoghi, persone o tempi del passato, che non si possono più rivivere. La parola è usato durante il diciassettesimo secolo dagli medici per descrivere la patologia degli soldati svizzeri lontani da casa. Oggi non è più una malattia, ma un'emozione universale: il desiderio di ritrovare qualcosa che abbiamo amato.

La nostalgia non è tristezza: è carburante perché è speranza. È ciò che ci fa credere che prima o poi torneremo a vincere. È un legame profondo con il passato che ci spinge verso il futuro.

E forse è proprio questo il bello: è ciò che ci fa vivere!

\section*{Adagio - ricerca}
Ma la corsa non è la mia unica passione. Oltre ai motori, c'è un'altra cosa che accompagna la mia vita: la musica. E qui arriva un'altra parola dal fascino speciale: adagio.
